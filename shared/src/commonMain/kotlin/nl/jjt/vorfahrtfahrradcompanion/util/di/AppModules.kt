...
import nl.jjt.vorfahrtfahrradcompanion.service.ride.KtorRideApi
...
import nl.jjt.vorfahrtfahrradcompanion.ui.criteria.till.TillCriteriaViewModel
...
val serviceModule = module {
    ...
    single<RideApi> { KtorRideApi(get(), get()) }
    single<RideUploader> { SendingRideUploader(get(), get(), get()) }
}

val uiModule = module {
    viewModel { JanCriteriaViewModel(get(), get(), get()) }
    viewModel { TillCriteriaViewModel(get(), get(), get()) }
